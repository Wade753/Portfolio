...
function animate() {
    //message for winner if score 100.000 or game over
    if (!game.active || score === 100000) {
        let text = game.active ? "Winner" : "Game Over"
        let textOffset = game.active ? 2.5 : 2.5;

        c.fillStyle = 'white'
        c.font = '70px Arial'
        c.fillText(text, canvas.width / textOffset, canvas.height / 2)
        return
    }
